...
public class smaliTreeWalker extends TreeParser {
	...
	@Override public String getGrammarFileName() { return "/usr/local/google/home/bgruv/android/aosp-master/external/smali/smali/src/main/antlr3/smaliTreeWalker.g"; }
	  ...
	  private Opcodes opcodes = new Opcodes(apiLevel, false);//ojo false
	  ...
	  public void setApiLevel(int apiLevel, boolean experimental) {
	      this.opcodes = new Opcodes(apiLevel, experimental);//ojo false
	      this.apiLevel = apiLevel;
	  }
	  
	  public void setApiLevel(int apiLevel) {
	      this.opcodes = new Opcodes(apiLevel, false);//ojo false
	      this.apiLevel = apiLevel;
	  }
